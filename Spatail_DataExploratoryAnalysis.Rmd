...
knitr::opts_knit$set(root.dir ='/Volumes/GoogleDrive/My Drive/Classes/Electives/SIE512/Week2/lab1')
getwd()
```
# Lab 1
...
## Read the data
```{r}
wjdata <- read.csv("Lab1_2022/WJData.csv", header = T, row.names = 1)
summary(wjdata)
```
